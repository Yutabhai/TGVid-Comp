...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7354411402:AAFM_WEoZsNNUDP_Xs4hngtJmkC1PYaYMgk") # ⚠️ Required
    FORCE_SUB = os.environ.get('FORCE_SUB', '-1002044619047') # ⚠️ Required
    ...
    DB_NAME  = os.environ.get("DB_NAME","ZoroEncBot") 

    # Other Configs 
    ADMIN = int(os.environ.get("ADMIN", "7179837246")) # ⚠️ Required
    LOG_CHANNEL = int(os.environ.get('LOG_CHANNEL', '-1002223844205')) # ⚠️ Required
